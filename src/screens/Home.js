        ...
        <Footer>
            <div className="row">
                <div className="col-6 col-md-4 col-lg-3">
                    {/* <Box as="form" background='primary' className="row p-3" style={{ marginTop: -70 }}>
                        <div className="col-sm-12  my-3">
                            <h3 className="text-center" style={{ textAlign: 'center' }} >Lets connect</h3>
                        </div>
